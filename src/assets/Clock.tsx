...
const Clock: React.FC<MyIconProps> = ({
  color = "#919191",
  width = 18,
  height = 18,
  style,
  ...
  <svg
    width={width} // widthを指定
    height={height} // heightを指定
    viewBox="0 0 18 18"
    fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={style} // styleを適用
  >
    <defs>
